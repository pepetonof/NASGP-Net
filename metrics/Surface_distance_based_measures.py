...
def compute_surface_distances(mask_gt, mask_pred, spacing_mm):
  ...
  # a = np.max(mask_all, axis=2)
  # print(np.max(mask_all, axis=2))
  ...
  # print(proj_0, proj_1, proj_2)
  # print(idx_nonzero_0,  idx_nonzero_1,  idx_nonzero_2)

  # print("bounding box min = {}".format(bbox_min))
  # print("bounding box max = {}".format(bbox_max))
  # print(bbox_max,bbox_min, type(bbox_max))
  # print((bbox_max - bbox_min)+2)
  ...
  # print(cropmask_gt.shape, cropmask_pred.shape)
  # print('Cropmask:\t',cropmask_gt, cropmask_pred)#cropmask_gt[0:-1, 0:-1, 0:-1])
  ...
  # # print(cropmask_gt)
  # # print(kernel)
  # print(neighbour_code_map_gt, neighbour_code_map_gt.shape)
  # print(borders_gt, borders_gt.shape)
  # print(distmap_gt) 
  # print(surface_area_map_gt)
  # print(distances_gt_to_pred)
  # print('selected', distmap_gt[borders_pred], distmap_gt[borders_pred].shape)
  # print(surfel_areas_gt)
  # print('PR')
  # # print(cropmask_pred)
  # # print(kernel)
  # print(neighbour_code_map_pred, neighbour_code_map_pred.shape)
  # print(borders_pred, borders_gt.shape)
  # print(distmap_pred)
  # print(surface_area_map_pred)
  # print(distances_pred_to_gt)
  # print('selected', distmap_pred[borders_gt], distmap_pred[borders_gt].shape)
  # print(surfel_areas_pred)
  
  # print('areas',neighbour_code_to_surface_area[[1,2,4,8,16,32,64,128]])
...
def compute_surface_dice_at_tolerance(surface_distances, tolerance_mm):
  ...
  overlap_pred = np.sum(surfel_areas_pred[distances_pred_to_gt <= tolerance_mm])
   ...
   # print()
   # print(surfel_areas_gt, surfel_areas_gt.shape)
   # print(surfel_areas_pred, surfel_areas_pred.shape)
   # print(distances_gt_to_pred)
   # print(distances_pred_to_gt)
   # print(distances_gt_to_pred <= tolerance_mm)
   # print(distances_pred_to_gt <= tolerance_mm)
   # print(surfel_areas_gt[distances_gt_to_pred <= tolerance_mm])
   # print(surfel_areas_pred[distances_pred_to_gt <= tolerance_mm])
   # print(overlap_gt, overlap_pred, np.sum(surfel_areas_gt), np.sum(surfel_areas_pred))
